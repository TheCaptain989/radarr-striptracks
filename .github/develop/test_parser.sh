...
[ "$striptracks_json_processed" = "$striptracks_json_processed_org" ] && echo -e "\t${ansi_green}JSON processing test passed!${ansi_nc}" || { 
...
[ "$striptracks_neworder" = "$striptracks_neworder_org" ] && echo -e "\t${ansi_green}Track order test passed!${ansi_nc}" || { 
...
[ "$striptracks_default_flags" = "$striptracks_default_flags_org" ] && echo -e "\t${ansi_green}Default flags test passed!${ansi_nc}" || { 
